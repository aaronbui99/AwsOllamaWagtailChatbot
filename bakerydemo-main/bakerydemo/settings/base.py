...
# Use AWS RDS database settings from environment variables
DATABASES = {
    "default": {
...
# Force the correct Ollama API URL
OLLAMA_API_URL = "http://ec2-54-252-174-64.ap-southeast-2.compute.amazonaws.com:11434/api/generate"
